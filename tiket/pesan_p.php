...
$sql = mysqli_query($connect, 'INSERT INTO reserv (reserv_code, reserv_at, reserv_date, seat, depart, price, id_user, id_customer, id_rute, status) VALUES ("' . $res_code . '", "' . $res_at . '", "' . $res_date . '", ' . $seat . ', "' . $depart . '", ' . $price . ', ' . $id_user . ', ' . $id_customer . ', ' . $id_rute . ', "' . $status . '") ');
if ($sql) {
