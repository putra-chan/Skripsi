            ...
            <div class="col s7">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col s6">
                                ...
                                $sr = mysqli_query($connect, 'select * from reserv where id_reserv="' . $id_reserv . '" ');
                                $fr = mysqli_fetch_array($sr);
                                ?>
                                <form>
                                    <?php
                                    $sfrom = mysqli_query($connect, 'select * from rute where id_rute="' . $fr['id_rute'] . '" ');
                            ...
                            <div class="col s6">
                                ...
                                <div class="input-field">
                                    <p>Price</p>
                                    <?php
                                    $mataUang = $ffrom['price'];
                                    $uangRupiah = "Rp. " . number_format($mataUang, 0, ',', '.');
                                    ?>

                                    <input type="text" id="price" value="<?= $uangRupiah; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            <div class="col s6">
                                <img src="../image/bayplane.png" class="center" style="width: 75px; height: 75px; margin-left: 100px;">
                            </div>
                            <div class="col s6">
                                <form>
                                    <div class="input-field">
            ...
            <div class="col s5">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        $scus = mysqli_query($connect, 'select * from customer where id_customer="' . $qc['id_customer'] . '" ');
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col s6">
                                <img src="../image/bayplane.png" class="center" style="width: 75px; height: 75px; margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
